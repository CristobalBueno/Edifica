...
class ActivityClientFormulary : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinnerSettlement.adapter = FormularySpinnerAdapter(
            this,
            R.id.formulary_tex_spinner_row,
            Dataholder.spinnerSettlement
        )


        spinnerProvince = findViewById<Spinner>(R.id.formulary_spinner_Province)
        spinnerProvince.adapter = FormularySpinnerAdapter(
            this,
            R.id.formulary_tex_spinner_row,
            Dataholder.spinnerProvince
        )
